...
INSERT INTO "user" (user_id, role_id, team_id, company_id, full_name, email, password_hash, avatar, phone, address, created_at, status) VALUES
    (gen_random_uuid(), 4, NULL, NULL, 'Admin System', 'adminSystem@space.com', '$2a$10$N.zmdr9k7uOCQb376NoUnuTJ8iAt6Z5EHsM8lE9lBOsl7iKTVEFDi', 'https://example.com/avatar1.jpg', '+REDACTED_PASSWORD67890', '123 Admin Street, City, State', NOW(), 'ACTIVE'),
